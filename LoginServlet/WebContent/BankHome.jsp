...
<head>
	...
	<title>Bank Credit Status</title>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="BankHome.jsp">Home</a></li>
			    	...
			    	<c:forEach items="${CredResults}" var="row">
			        	<tr class="info"  >
			            	...
			            	<!-- Form has to go inside for loop inorder for hidden value to attribute to each row -->
			            		<form  method="POST" action="bankCreditpath">
					            	<input type="hidden" name="userId1"  value="${row.userName}">
					            	<input type=submit id="approve"  name="approve"  value="Approve">
			        			</form>
			        			<form  method="POST" action="bankCreditpath">
			        				<input type="hidden" name="userId2"  value="${row.userName}">
