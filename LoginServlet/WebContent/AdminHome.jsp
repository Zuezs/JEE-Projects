...
<title>Management Home</title>
  ...
  <body>
  <%-- 	<div id="load_screen"><div id="loading"> <%@include file="LoadPage.jsp"  %> </div></div> --%>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="jumbotron">
            ...
            <p>You Are The Admin Do What You Like!.</p>
          </div>
          <div class="row">
            <div class="col-xs-6 col-lg-4">
              <h2>No Intro Needed</h2>
              <p>You created this Page! </p>
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
          <div class="list-group">
            <a href="AdminEditCredit.jsp" class="list-group-item active">Your Customers Credit Reports</a>
            <a href="AdminEditRegister.jsp" class="list-group-item">Your Customers Registration Reports</a>
