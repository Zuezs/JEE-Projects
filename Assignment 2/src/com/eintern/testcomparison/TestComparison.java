...
public class TestComparison{
	...
	public static void main(String[] args){
		...
		//Creating teacher and programmer objects from the classes
				...
				int num = teacher[0].compare(teacher[0], teacher[1]);
				...
				int num1 = programmer[0].compare(programmer[0],programmer[1]);
				//Testing if it works and is true
				...
				if((teacher[0].compare(teacher[0], programmer[0])) == 0 && (programmer[0].compare(programmer[0], teacher[0])) == 0){
